...
ggsave("/Users/aliciahobdell/Desktop/final_project/zymobiomics_folder/results/read_number_progression.png", width = 8, height = 5, dpi = 300)
...
ggplot(length_long, aes(
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
ggsave("/Users/aliciahobdell/Desktop/final_project/zymobiomics_folder/results/read_length_progression.png", width = 8, height = 5, dpi = 300)
